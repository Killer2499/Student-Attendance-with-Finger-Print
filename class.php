           ...
           <?php  } ?>
                ...
                <form method="post" action="classadd.php" >
                    ...
                    <div class="form-group">
                        Class ID : <input type="number" name="class_id" min="1" class="form-control" placeholder="ID" required >
                  ...
                  <button> <input type="submit" name="submit" class="btn btn-danger" value="submit"> </button>
